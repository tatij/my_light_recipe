...
class ConnectDishBook(models.Model):
    ...
    id_dish = models.ForeignKey('Book')
    
class Dish(models.Model):
    id_dish = models.ForeignKey('ConnectDishBook')
    id_dish = models.ForeignKey('Recipe')
...
class Recipe(models.Model):
    ...
    id_dish = models.ForeignKey('Dish')
...
class Ingredient(models.Model):
    id_ingredient = models.ForeignKey('Recipe')
    id_ingredient = models.ForeignKey('Recipe')
